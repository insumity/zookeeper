            ...
            while ((self.getPeerState() == ServerState.LOOKING) && (!stop)) {
                ...
                if (n == null) {
                    ...
                    case LEADING:
                         ...
                         * If this was not the case, it could be that the leader exists in outofelection, but the
                         * majority exists in recvset. In such a scenario, a participant cannot join the ensemble.
                         * See ZOOKEEPER-1732 for more information (i.e., FLETEst.testJoinInconsistentEnsemble()).
                         */
